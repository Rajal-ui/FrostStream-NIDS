...
ALTER TABLE FLOW_FEATURES ADD COLUMN IF NOT EXISTS IS_SYNTHETIC BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE NIDS_ALERTS ADD COLUMN IF NOT EXISTS IS_SYNTHETIC BOOLEAN NOT NULL DEFAULT FALSE;

UPDATE FLOW_FEATURES
SET IS_SYNTHETIC = TRUE
WHERE FLOW_ID IN ('0bbeb61ddb628f4fc1bb42a5110ec5ad', '771fd02e10031fa4605af27ae001422d');
...
CREATE OR REPLACE VIEW LIVE_FLOW_FEATURES AS
SELECT * FROM FLOW_FEATURES WHERE IS_SYNTHETIC = FALSE;

CREATE OR REPLACE VIEW LIVE_NIDS_ALERTS AS
SELECT * FROM NIDS_ALERTS WHERE IS_SYNTHETIC = FALSE;
